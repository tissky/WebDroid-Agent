...
[在线体验（历史 Pages 域名）](https://webadb-autoglm.pages.dev/) · [英文版](./README.en-US.md) · [Tango / WebADB](https://github.com/yume-chan/ya-webadb)
...
src/
  adapters/
    ...
    deviceBackend.ts          # 设备后端兼容导出口
    deviceCommands.ts         # ADB 命令构建、输入法和敏感动作确认
